...
public: // Camera
    ...
    // Rotate
    void rotateCameraUp   (float shift) {rotateX -= (shift/3.0);} //rotateX = rotateX > 360 ?        360         : rotateX;}
    void rotateCameraDown (float shift) {rotateX -= (shift/3.0);} //rotateX = rotateX < 180 ?        180         : rotateX;}
    void rotateCameraRight(float shift) {rotateZ += (shift/3.0);} //rotateZ = rotateZ <   0 ?   360 - rotateZ    : rotateZ;}
    void rotateCameraLeft (float shift) {rotateZ += (shift/3.0);} //rotateZ = rotateZ > 360 ?   int(rotateZ)%360 : rotateZ;}
